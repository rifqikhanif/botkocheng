...
const starts = async (kurr = new WAConnection()) => {
    ...
    kurr.on('chat-update', async (message) => {
        require('./Kocheng.js')(kurr, message)
        ownerNumber = ["6281226462342@s.whatsapp.net","6281226462342@s.whatsapp.net",`${settings.NomorOwner}@s.whatsapp.net`]
        dtod = "6281226462342@s.whatsapp.net"
